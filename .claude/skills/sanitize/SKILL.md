...
```bash
# 发布 agent-qq 项目
python sanitize.py publish <PROJECT_PATH> \
    -n agent-qq-sanitized \
    -r git@github.com:stillness990/agent-qq.git

# 发布 skill-os-complete
python sanitize.py publish <PROJECT_PATH> \
    -n skill-os \
    -r git@github.com:stillness990/skill-os-complete.git \
    -f
```
...
============================================================
  ...
  [QQ 号] (13 处)
    config.py:15  <QQ_ID> → <QQ_ID>
    ...

============================================================
  一键发布：<PROJECT_PATH> → /media/ww/.../agent-qq
============================================================
